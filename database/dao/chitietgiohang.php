<?php
    function insert_chitiet_giohang($id_gio_hang,$id_ctsp,$so_luong,$trang_thai,$id_chitiet_donhang){
        $sql = "INSERT INTO chi_tiet_giohang(id_gio_hang,id_ctsp,so_luong,trang_thai,id_chitiet_donhang) VALUES ('$id_gio_hang','$id_ctsp','$so_luong','$trang_thai','$id_chitiet_donhang')";
        pdo_execute($sql);
    }
