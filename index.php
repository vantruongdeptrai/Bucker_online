            ...
            if (isset($_POST["add_to_cart"]) && $_POST["add_to_cart"]) {
                if (isset($_SESSION["user"])) {
                    ...
                    if (!isset($gio_hang) || empty($gio_hang)) {
                        $id_gio_hang = insert_giohang($id_user, $ngay_tao_gh,$trang_thai);
                    }
                    
                    //thêm sản phẩm vào giỏ hàng
                    insert_chitiet_giohang($gio_hang[0]["id_gio_hang"], $id_ctsp, $so_luong,$trang_thai,0);
        ...
        case 'xoa_giohang':
            if(isset($_SESSION["user"])){
                ...
                if(empty($gio_hang)){
                    ...
                    insert_giohang($id_user, $ngay_tao_gh,$trang_thai);
                }
            }
            $load_chitiet_giohang = load_chitiet_giohang();
            include('view/cart/cart.php');
